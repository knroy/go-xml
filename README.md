...
| **XSLT 2.0** | 99.59% of the W3C XSLT suite filtered to 2.0 (6,027 of 6,052 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   99.59% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 6027 passed, 25 failed (99.59%)
```
