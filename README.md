...
| | |
|---|---|
| **XPath 2.0** | 99.92% of the W3C QT3 suite (15,169 of 15,181 in scope) |
...
**12 of 15,181 in-scope cases fail (0.08%).** One cluster and a long tail:
...
in-scope: 15169 passed, 12 failed (99.92%)
```
