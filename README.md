...
| **XSD 1.0** | 99.88% of the W3C xsdtests *instance* tests (24,969 of 25,000); **99.40%** of its *schema-validity* tests (14,318 of 14,405) |
| **XSD 1.1** | 99.89% instance (26,178 of 26,206); **98.72%** schema-validity (15,169 of 15,365); opt-in via `Version11` |
...
1. **Schema-validity is the weakest of the measured numbers**, at 99.40% (1.0)
   and 98.72% (1.1) — a schema invalid in one of the remaining ways is
...
|---|---|---|
| XSD 1.0 | 14,318 / 14,405 (99.40%) | 24,969 / 25,000 (99.88%) |
| XSD 1.1 | 15,169 / 15,365 (98.72%) | 26,178 / 26,206 (99.89%) |
