...
| **XSLT 2.0** | 62.64% of the W3C XSLT suite filtered to 2.0 (3,363 of 5,369 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   62.64% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 3363 passed, 2006 failed (62.64%)
```
