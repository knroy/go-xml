...
| **XSLT 3.0** | 99.69% of the W3C XSLT suite filtered to 3.0 (8,596 of 8,623 in scope). Streaming is not implemented, and its 2,716 cases are out of scope rather than failing — see [Where it fails](#where-it-fails) |
| **XSD 1.0** | 99.87% of the W3C xsdtests *instance* tests (24,967 of 24,999); **99.85%** of its *schema-validity* tests (14,384 of 14,405) |
| **XSD 1.1** | 99.89% instance (26,177 of 26,207); **99.80%** schema-validity (15,334 of 15,365); opt-in via `Version11` |
...
1. **Schema-validity is the weaker half of the XSD numbers**, at 99.85% (1.0)
   and 99.80% (1.1) — a schema invalid in one of the remaining ways is
   ...
   of them — 89 of 114 — are cases the W3C itself has queried**, including
...
3. **XSLT 3.0 is the youngest of the measured numbers**, at 99.69%, and still
...
| XSD 1.1 | 15,334 / 15,365 (99.80%) | 26,177 / 26,207 (99.89%) |
