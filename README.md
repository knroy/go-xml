...
| **XSLT 2.0** | 78.93% of the W3C XSLT suite filtered to 2.0 (4,238 of 5,369 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   78.93% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 4238 passed, 1131 failed (78.93%)
```
