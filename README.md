...
| **XSLT 2.0** | 98.18% of the W3C XSLT suite filtered to 2.0 (5,272 of 5,370 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   98.18% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
XSLT suite: 14601 cases, 5370 in scope, 9231 skipped
in-scope: 5272 passed, 98 failed (98.18%)
```
