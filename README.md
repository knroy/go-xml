...
| **XSD 1.0** | 99.80% of the W3C xsdtests *instance* tests (24,953 of 25,002); **98.54%** of its *schema-validity* tests (14,194 of 14,405) |
| **XSD 1.1** | 99.79% instance (26,154 of 26,208); **97.82%** schema-validity (15,030 of 15,365); opt-in via `Version11` |
...
|---|---|---|
| XSD 1.0 | 14,194 / 14,405 (98.54%) | 24,953 / 25,002 (99.80%) |
| XSD 1.1 | 15,030 / 15,365 (97.82%) | 26,154 / 26,208 (99.79%) |
