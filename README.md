...
| **XSLT 2.0** | 97.26% of the W3C XSLT suite filtered to 2.0 (5,225 of 5,372 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   97.26% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 5225 passed, 147 failed (97.26%)
```
