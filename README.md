...
| **XSLT 2.0** | 92.16% of the W3C XSLT suite filtered to 2.0 (4,949 of 5,370 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   92.16% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 4949 passed, 421 failed (92.16%)
```
