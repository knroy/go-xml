...
| **XSLT 2.0** | 99.24% of the W3C XSLT suite filtered to 2.0 (6,006 of 6,052 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   99.24% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
XSLT suite: 14601 cases, 6052 in scope, 8549 skipped
in-scope: 6006 passed, 46 failed (99.24%)
```
