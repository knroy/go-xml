...
| **XSLT 2.0** | 76.70% of the W3C XSLT suite filtered to 2.0 (4,118 of 5,369 in scope); verified against Saxon-HE 12.4 on two production corpora |
...
3. **XSLT is the weakest of the measured numbers, by a long way.** It sits at
   76.70% of the W3C suite filtered to XSLT 2.0, against 98%+ for everything
...
in-scope: 4118 passed, 1251 failed (76.70%)
```
