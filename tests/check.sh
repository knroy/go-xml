...
docfigure "unit test count" 1465 "$(docfigure_tests)" \
	README.md:109 README.md:1221 docs/testing.md:23 docs/todo.md:20
docfigure "fuzz target count" 6 "$(docfigure_fuzz)" \
