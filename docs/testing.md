...
| **Unit tests** | 2,255 | a plausible implementation that is quietly wrong | anything nobody thought to write a test for |
...
ratchet's, in every form the documents use: `11,490 of 11,518`,
`28 of 11,518`, `11,490 / 11,518 (99.76%)`, `= 99.76%`, `(28 failing)`, and
