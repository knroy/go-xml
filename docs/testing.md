...
ratchet's, in every form the documents use: `11,482 of 11,518`,
`36 of 11,518`, `11,482 / 11,518 (99.69%)`, `= 99.69%`, `(36 failing)`, and
the `| 11,518 | 11,482 | 99.69% | **36** |` summary-table row. A line stating
