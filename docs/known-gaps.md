...
Counted by scanning each test's `<current status=...>`. That leaves 70
addressable in 1.0 and 174 in 1.1. See *What 100% would take* below for why
...
| XSD 1.0 schema | **99.40%** | **~99.6%** | 81 addressable false accepts, one at a time |
| XSD 1.1 schema | **98.72%** | **~99.6%** | 184 addressable false accepts, one at a time |
