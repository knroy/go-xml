...
Counted by scanning each test's `<current status=...>`. That leaves 62
addressable in 1.0 and 166 in 1.1. See *What 100% would take* below for why
...
| XSD 1.0 schema | **99.45%** | **~99.6%** | 73 addressable false accepts, one at a time |
| XSD 1.1 schema | **98.78%** | **~99.6%** | 176 addressable false accepts, one at a time |
