...
failures of 6,201; XQuery 3.1 has 42 of 30,346; XSLT 3.0 has 126 of 11,525;
...
**103 of the 126 XSLT 3.0 failures**, and by far the largest single gap in the
...
cases still wanting an `XTSE3430` and take XSLT 3.0 from 98.91% to about
...
The remaining 23 are singletons or near-singletons and are catalogued in
