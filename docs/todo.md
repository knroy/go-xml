...
| XSLT 3.0 | 99.35% — 11,443 of 11,518 in scope (75 failing); 103 of those 126 need more of the §19.8 streamability analysis |
| RELAX NG | 100.00% — 965 of 965 |
| Schemas wrongly refused | 7 — 6 on XSD 1.0, 1 on 1.1 |
| Tests | 1,876 `func Test` declarations, clean under `-race` |
