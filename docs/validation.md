...
Measured against the W3C XSD test suite: **99.81%** agreement on 25,003
instance tests, and **98.60%** on its 14,405 schema-validity tests — the
...
versioning attributes, and the 1.1 built-ins. It measures **99.81%** on the
26,209 instance tests that apply to a 1.1 processor and **97.96%** on the
