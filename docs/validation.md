...
Measured against the W3C XSD test suite: **99.09%** agreement on 24,473
instance tests.
...
versioning attributes, and the 1.1 built-ins. It measures **99.53%** on the
suite's 1.1 instance tests (1,053 of 1,058).
