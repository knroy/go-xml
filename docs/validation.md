...
Measured against the W3C XSD test suite: **99.80%** agreement on 25,002
instance tests, and **98.54%** on its 14,405 schema-validity tests — the
...
26,208 instance tests that apply to a 1.1 processor and **97.82%** on the
