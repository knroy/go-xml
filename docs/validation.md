...
Measured against the W3C XSD test suite: **99.86%** agreement on 24,999
instance tests, and **99.74%** on its 14,405 schema-validity tests — the
...
versioning attributes, and the 1.1 built-ins. It measures **99.88%** on the
26,205 instance tests that apply to a 1.1 processor and **99.53%** on the
