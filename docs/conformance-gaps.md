...
| **xquery** | QT3 — XQuery 3.1 | 30,346 | 30,263 | 99.73% | **83** | 0 | 0 | **83** | 99.73% |
...
**XQuery 3.1: 30,263 / 30,346 = 99.73%** — what passes now. The denominator
...
cases pass and 83 fail, which is the whole of the increase in the failure
count. The passing count rose by more than 311 — 29,918 → 30,263 — because four
