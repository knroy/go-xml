...
long tail**: 103 of the 126 XSLT 3.0 failures want an `XTSE3430` that only the
...
**XSLT 3.0: 11,399 / 11,525 = 98.91%** — the §19.8 analysis now exists and its
first 13 sections moved 19 cases. Of the 126 remaining, **118 want an
