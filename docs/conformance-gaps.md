...
| **xslt** | W3C XSLT 3.0 | 11,525 | 11,399 | 98.91% | **126** |
...
**The two largest blocks are single features, not a long tail.** 103 of the 126
...
**XSLT 3.0: 11,399 / 11,525 = 98.91%.**

**103 of the 126 want an `XTSE3430`** — a refusal of a stylesheet as
...
The XSLT 3.0 suite has 14,601 cases; 11,525 are in scope. The 3,076 skipped are
