...
| **xquery** | QT3 — XQuery 3.1 | 30,346 | 30,255 | 99.70% | **91** | 0 | 0 | **91** | 99.70% |
...
**XQuery 3.1: 30,255 / 30,346 = 99.70%** — what passes now. The denominator
...
cases pass and 91 fail, which is the whole of the increase in the failure
count. The passing count rose by more than 303 — 29,918 → 30,255 — because four
