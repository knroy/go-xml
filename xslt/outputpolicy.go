...
// removal rule applies, so two xsl:sequence instructions selecting the empty
// string leave a text node holding that space. on-empty-115a builds that document
